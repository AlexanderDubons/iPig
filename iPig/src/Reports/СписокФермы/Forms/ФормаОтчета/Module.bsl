...
Процедура СформироватьНаСервере()
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		Если ВыборкаДетальныеЗаписи.НомерЖивотного <> НомерЖивотного И ЗначениеЗаполнено(
			ОбластьСтрока.Параметры.НомерЖивотного) Тогда
		...
		Если ВыборкаДетальныеЗаписи.НомерОпороса > 0 Тогда
			...
			Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.НомерОпороса) Тогда
				Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.ДатаОсеменения) И Не ЗначениеЗаполнено(
