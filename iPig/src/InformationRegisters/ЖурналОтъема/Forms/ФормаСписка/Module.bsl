...
// реквизит1 - динамический список на форме
	...
	Если КоличествоОтъемов > 0 Тогда
		КоличествоОтъемышей = Строка(КоличествоОтъемышейКоличество)+ " / " + Строка(Окр(КоличествоОтъемышейКоличество/КоличествоОтъемов,2));
		МассаВсего          = Строка(МассаВсегоКоличество)+ " / " + Строка(Окр(МассаВсегоКоличество/КоличествоОтъемов,2));
		СреднийВес          = Строка(СреднийВесКоличество)+ " / " + Строка(Окр(СреднийВесКоличество/КоличествоОтъемов,2));
	КонецЕсли;
