...
Процедура ЗаписатьОсеменения(Команда)
	Для Каждого Запись ИЗ ТЧДанные Цикл 
		Попытка
			...
			Запись.КодМеста, Запись.НомерОпороса, Запись.Мачеха, Запись.КоличествоОтъемышей, Запись.МассаВсего, Запись.СреднийВес, Запись.ТолщинаШпика);
...
&НаСервере
Процедура СоздатьЗаписьЖурналаОтъемаНаСервере(Знач ДатаОтъема, Знач НомерЖивотного, Знач ДатаВвода, Знач Место, Знач НомерОпороса, Знач Мачеха, Знач КоличествоОтъемышей, Знач МассаВсего, Знач СреднийВес, Знач ТолщинаШпика)
